# -*- coding: utf-8 -*-
"""
Created on Sun May 27 20:24:42 2018
...
#Prepare input data
classes = os.listdir('apple_training')
num_classes = len(classes)

validation_size = 0.2
img_size = 256
num_channels = 3
train_path = 'apple_training'
...
def create_convolutional_layer(input,
    ...
    layer = tf.nn.max_pool(value=layer,
                           ...
                           strides=[1, 2, 2, 1],
                           padding='SAME')
    # Output of pooling is fed to Relu wich is the activation function
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            saver.save(session, 'C:/Users/LuísFelipeVieiraSilv/Pictures/PDI/models/apple') 
